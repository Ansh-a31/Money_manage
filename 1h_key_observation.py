'''
                                                   1H DATA   KEY PATTERN OBSERVATIONS                           
...
Volatility Spike:
If garman_klass_vol > 0.01, expect a large move (>2000 pips) next hour.
Extreme Move:
If |Pips_Moved| > 5000, expect a reversal (50-70% of the time).
Time Window:
Trade between 17:00 - 20:00 IST for highest activity.
------------------------------------------------------------------------
